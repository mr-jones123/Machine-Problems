        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="details.php?id=<?php echo $row['ID']; ?>"><button id="btn-table">View
                                Details</button></a></td>
                    <td><a href="edit.php?id=<?php echo $row['ID']; ?>"><button id="btn-table">Edit</button></a></td>
                    <td><a href="delete.php?id=<?php echo $row['ID']; ?>"
                            onclick="return confirm('Are you sure you want to delete this device?');"><button
                                id="btn-table">Delete</button></a></td>
